...
\begin{table}[H]
    ...
    \begin{tabular}{@{}lp{9.5cm}@{}}
        ...
        \bottomrule
    \end{tabular}
    \caption{Instrucciones x86 y FPU utilizadas en el programa}
\end{table}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{imagenes/fpu_registers_bucle.png}
    \caption{Ventana Registers de Visual Studio: registros FPU \texttt{ST(0)}--\texttt{ST(7)} y \texttt{ECX} durante el bucle de acumulación.}
    \label{fig:fpu_registers}
\end{figure}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\textwidth]{imagenes/consola_ejecucion.png}
    \caption{Salida en consola del programa para $\vec{u}=(2,3,4)$ y $\vec{v}=(1,5,2)$: resultado 25.}
    \label{fig:consola_ejecucion}
\end{figure}

% ============================================================
\section{Repositorio GitHub}

\url{https://github.com/7mo-ArquitecturaComputadoras/Practica05_ProductoPunto}
